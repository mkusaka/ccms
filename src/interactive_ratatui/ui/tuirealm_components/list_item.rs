...
/// This is kept for compatibility with the existing codebase
...
// Implement for SearchResult (for compatibility)
...
mod tests {
    ...
    fn test_truncate_message() {
        ...
        assert_eq!(truncate_message("Test\nMultiline", 20), "Test Multiline");
        assert_eq!(truncate_message("こんにちは世界", 5), "こん...");
    }
    ...
    fn test_wrap_text() {
        ...
        assert_eq!(
            wrap_text("This is a long text that needs wrapping", 10),
            vec!["This is a", "long text", "that needs", "wrapping"]
        );
        assert_eq!(wrap_text("", 10), vec![""]);
        assert_eq!(wrap_text("NoSpaces", 4), vec!["NoSpaces"]);
    }
}