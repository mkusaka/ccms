#[cfg(test)]
mod tests {
    use crate::{SearchOptions, SearchResult, QueryCondition};
    ...
    fn test_message_json_parsing() {
        ...
        assert_eq!(msg.get("content").and_then(|v| v.as_str()), Some("Test message"));
        assert_eq!(msg.get("timestamp").and_then(|v| v.as_str()), Some("2024-01-01T00:00:00Z"));
    }
