...
mod tests {
    ...
    fn test_file_discovery() -> Result<()> {
        ...
        // Create test files
        File::create(base_path.join("project1/session1.jsonl"))?
            .write_all(b"test")?;
        File::create(base_path.join("project1/session2.jsonl"))?
            .write_all(b"test")?;
        File::create(base_path.join("project2/session3.jsonl"))?
            .write_all(b"test")?;
        File::create(base_path.join("project2/subdir/session4.jsonl"))?
            .write_all(b"test")?;
        File::create(base_path.join("project1/other.txt"))?
            .write_all(b"test")?;
